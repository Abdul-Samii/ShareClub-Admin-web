...
const Category = (props) =>{
    ...
    const handleDelete=(id)=>{
        ...
        fetch('http://localhost:6600/admin/category/'+id, {
          method: 'DELETE',
          headers: {
      ...
      const handleAddCategory=()=>{
        ...
        :(
        fetch('http://localhost:6600/admin/category', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
...
console.log(category)
    return(
        ...
        <h2 className='font-bold md:absolute'>Add New Category</h2>
...
export async function getServerSideProps() {
    ...
    const res = await fetch(`http://localhost:6600/admin/category`)
    console.log("MAI ",res)
